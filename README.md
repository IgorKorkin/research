...
| :---: | --- | --- | --- |
| 2009–2015 | **Memory Forensics for Rootkit Detection** | Выявление kernel-mode rootkits и скрытых структур ОС на основе анализа содержимого дампа памяти | [Applying Memory Forensics to Rootkit Detection](https://commons.erau.edu/cgi/viewcontent.cgi?article=1291&context=adfsl) |
