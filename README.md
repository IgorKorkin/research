...
| :---: | --- | --- | --- |
| 2009–2015 | **Memory Forensics for Rootkit Detection** | Выявление kernel-mode rootkits и скрытых объектов ОС на основе анализа оперативной памяти | [Applying Memory Forensics to Rootkit Detection](https://arxiv.org/abs/1506.04129) |
| 2010–2014 | **Stealthy Hypervisor Detection** | Обнаружение скрытых гипервизоров, включая противодействие time cheating и нестабильности временных измерений | [Two Challenges of Stealthy Hypervisors Detection](https://arxiv.org/abs/1506.04131) |
| 2016–2022 | **MemoryRanger — Hypervisor-based Kernel Protection** | Развитие гипервизорных механизмов защиты на базе VT-x/EPT: от ранних экспериментов с HyperPlatform до изоляции драйверов, памяти и объектов ядра Windows | [GitHub](https://github.com/IgorKorkin/MemoryRanger) |
| 2019–2022 | **Security Telemetry Under Attack** | Анализ устойчивости ETW/WMI и механизмов наблюдения EDR/SIEM к активному противодействию | [Research profile](https://igorkorkin.github.io/) · [Research archive](https://sites.google.com/site/igorkorkin) |
| 2025–2026 | **DesktopRanger — Windows Desktop Isolation** | Усиление Windows Desktop isolation и защита пользовательского ввода | [GitHub](https://github.com/IgorKorkin/DesktopRanger) · [OFFZONE 2026](https://offzone.moscow/eng/program/beyond-secure-desktop-abusing-and-hardening-windows-desktop-isolation/) |
